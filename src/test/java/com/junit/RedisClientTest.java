...
public class RedisClientTest {
    ...
    @Before
    public void setup() {
        //连接redis服务器，118.89.139.135:6379
        jedis = new Jedis("118.89.139.135", 6379);
        //权限认证
        jedis.auth("myredis");
    }
    ...
    public void testRedisPool() {
        ...
        String getTaskid = jedis.rpoplpush("a", "tmp-queue");
        System.out.println(getTaskid);
        //从任务队列"task-queue"中获取一个任务，并将该任务放入暂存队列"tmp-queue"
        String getTaskid2 = jedis.rpoplpush("a", "tmp-queue");

        System.out.println(getTaskid2);
//        RedisClient.getJedis().set("newname", "中文测试");
...
//        System.out.println(RedisClient.getJedis().get("newname"));
    ...
    public void testRedisQueue() {
        ...
        //从任务队列"task-queue"中获取一个任务，并将该任务放入暂存队列"tmp-queue"
        String getTaskid = jedis.rpoplpush("task-queue", "tmp-queue");
